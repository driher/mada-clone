...
export default function BigHeroSlider() {
  ...
  if (!slides.length) {
    return (
      <div className="w-full h-[680px] bg-slate-200 animate-pulse rounded-2xl" />
    );
  }
          ...
          >
            <div className="relative h-[620px] lg:h-[680px]">
              ...
              <div className="absolute inset-0 z-20 flex items-center">
                <div className="w-full max-w-7xl pl-6 pr-8 ml-4 md:ml-8 md:pl-12 md:pr-16">
                  <div className="max-w-3xl text-white">
                    ...
                    <p
                      ...
                      "
                    >
                      Mencetak komunikator, jurnalis, praktisi media,
                      dan humas profesional yang unggul,
                      adaptif, kreatif, serta berdaya saing global
